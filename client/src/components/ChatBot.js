...
function ChatBot({ setUserTrainingPlan, setUserDietPlan, setHasAllUserData }) {
  ...
  const [messagesHistory, setMessagesHistory] = useState([
    ...
    { role: "user", content: "Hey Ronnie!" },
    {
      role: "assistant",
      content:
        "Hey, im Ronnie Coleman, the legendary bodybuilder and 8x Mr. Olympia, how can i help you?",
    },
  ]);
    ...
    (message, index) =>
      index > 1 && (
        <div
          ...
          className={`row ${
            message.role === "user"
              ? "justify-content-end bg-secondary"
              : "bg-success"
          }`}
          style={
            message.role === "user"
    ...
    <div className="d-flex flex-column h-100">
      <div className="row mb-auto">
        <div className="d-flex justify-content-between secondary">
          <h2 className="p-3 rounded-bottom">Ronnie</h2>
          <img
            src="./images/coleman.webp"
            className="img-fluid"
            alt="ronnie coleman"
          />
        </div>
          ...
          <OverlayTrigger
            ...
            overlay={
              <Popover id={`popover-positioned-left`}>
                <Popover.Header as="h3">{`Help with Ronnie`}</Popover.Header>
                <Popover.Body>
                  Chat with Ronnie as he asks you about your lifestyle to
                  determine the best diet and training plans for you. Be patient
                  with him, its his first day here.
                </Popover.Body>
              </Popover>
            }
          >
