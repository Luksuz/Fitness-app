...
export default function Settings() {
    ...
    async function handleDeleteAccount(event) {
        ...
        if (password === confirmPassword && confirm('Are you sure you want to delete your account?')) {
            const userID = sessionStorage.getItem("userID");
  ...
  return (
    ...
    <Accordion>
      <Accordion.Item eventKey="0">
        ...
        <Accordion.Body>
          ...
          <div className="form-group">
            ...
            <Button type="submit" className="btn btn-success mt-2" onClick={handlePasswordSubmit}>
                Submit
                </Button>
          </form>
        </Accordion.Body>
      ...
      <Accordion.Item eventKey="1">
        ...
        <Accordion.Body>
        <p className='text-danger'>Deleting you account will erase your credentials, as well as all of your training and diet plans.
        </p>
        <form>
          <div className="form-group">
            ...
            <Button type="submit" className="btn btn-danger mt-2" onClick={handleDeleteAccount}>
                Delete Account
                </Button>
          </form>
